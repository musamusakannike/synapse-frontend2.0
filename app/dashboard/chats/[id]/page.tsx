...
export default function ChatDetailPage() {
  ...
  const handleClearMessages = async () => {
    if (!chat || !confirm("Are you sure you want to clear all messages?"))
      return;
  ...
  return (
    <DashboardLayout>
      <div className="w-screen overflow-x-hidden sm:overflow-x-auto sm:max-w-4xl mx-auto h-[calc(100vh-12rem)] flex flex-col">
        {/* Header */}
        <Card className="mb-4">
          <CardHeader>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 w-full">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-2">
                    <Badge
                      variant="secondary"
                      className={getSourceColor(chat.type)}
                    >
                      {chat.type}
                    </Badge>
                    ...
                    <span className="text-sm text-gray-500">{`Created ${formatDate(
                      chat.createdAt
                    )}`}</span>
                  </div>
                </div>
